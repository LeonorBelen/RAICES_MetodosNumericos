...
def f(x):
    """Función: f(x) = x^2 - 1.25x - 0.75"""
    return x**2 - 1.25 * x - 0.75

def df(x):
    """Derivada: f'(x) = 2x - 1.25"""
    return 2 * x - 1.25
...
print("--- PROBLEMA: Raíz Positiva de f(x) = x^2 - 1.25x - 0.75 ---")
# Bisección: Intervalo [1, 2]
print(biseccion(1, 2, TOL))
# Newton-Raphson: Valor inicial x0 = 1.5
print(newton_raphson(1.5, TOL))
# Secante: Valores iniciales x_-1 = 1, x_0 = 2
print(secante(1, 2, TOL))